...
const OrderConfirmation = ({departure, selectedPlace, passenger, payment, handleConfirmation}) => {
    ...
    const cost = calculatePrice(selectedPlace.coach, selectedPlace.place);
    ...
    return (
        <div className="order-confirmation">
            ...
            <div className="order-data">
                ...
                <div className="order-data-content">
                    <div className='passenger-data'>
                        <img className="passenger-data-image" src={`${process.env.PUBLIC_URL}/img/passenger.png`} alt="" />
                        <div className='passenger-data-info'>
                            <div className='passenger-data-info-main'>{passenger.lastName} {passenger.name} {passenger.thirdName}</div>
                            <div className='passenger-data-info-second'>{passenger.birthDate}</div>
                            <div className='passenger-data-info-second'>Паспорт РФ {passenger.serial} {passenger.number}</div>
                        </div>
                    </div>
                    <div className='price-data'>
                        <div className='price-data-text'>
                            Всего <span className='price-data-cost'>{cost}</span>
            ...
            <div className='confirmation-footer'>
                <button className='confirmation-button' onClick={handleNext}>Подтвердить</button>
            </div>
        </div>
    )
}
