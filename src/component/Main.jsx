            ...
            <div id="how-it-works" className="how-it-works">
                ...
                <div className="how-it-works-content">
                    <div className="how-it-works-item">
                        <img className="how-it-works-icon" src={`${process.env.PUBLIC_URL}/img/how-1.png`} alt="Иконка удобства для заказа на сайт"/>
                        <div className="how-it-works-text">Удобный заказ на сайте</div>
                    </div>
                    <div className="how-it-works-item">
                        <img className="how-it-works-icon" src={`${process.env.PUBLIC_URL}/img/how-2.png`} alt="Иконка отутствия необходимости ехать в офис"/>
                        <div className="how-it-works-text">Нет необходимости ехать в офис</div>
                    </div>
                    <div className="how-it-works-item">
                        <img className="how-it-works-icon" src={`${process.env.PUBLIC_URL}/img/how-3.png`} alt="Иконка огромного выбора направлений"/>
            ...
            <div id="feedback" className="feedback">
                ...
                <div className="feedback-list">
                    <div className="feedback-item">
                        <img className="feedback-image" src={`${process.env.PUBLIC_URL}/img/feedback-1.png`} alt="Фото автора отзыва"/>
                    ...
                    <div className="feedback-item">
                        <img className="feedback-image" src={`${process.env.PUBLIC_URL}/img/feedback-2.png`} alt="Фото автора отзыва"/>
                        <div className="feedback-content">
